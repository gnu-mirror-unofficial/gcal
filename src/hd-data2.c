/*
*  hd-data2.c:  All other A-C countries data which is composed into the
...
#if !HD_TOP20CC
#  ifdef RCSID
static char rcsid[]="$Id: hd-data2.c 3.01 2000/06/14 03:00:01 tom Exp $";
#  endif
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, "+", 14, 3, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_SHEIKH_ZAYEDS_ASCENSION_DAY].ht_text),
...
*/
{
   ...
   for (i=0 ; i < DAY_MAX ; i++)
     holiday (*init_data, detected, _(hd_text[HD_CARNIVAL].ht_text),
              ptr_cc_id, DIS_HLS_PREF2, day+i, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, "+", day+4, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
            ptr_cc_id, "+", easter-2, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MOTHERHOOD_AND_BEAUTY_DAY].ht_text),
...
*/
{
   ...
   for (i=day = eval_holiday (DAY_MIN, MONTH_MAX, year, 6, TRUE) ; day < i+2 ; day++)
     holiday (*init_data, detected, _(hd_text[HD_SABA_DAY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_ARMED_STRUGGLE].ht_text),
            ptr_cc_id, "+", 4, 2, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_FOUNDATION_OF_NPLA_DAY].ht_text),
   ...
   holiday (*init_data, detected, _(hd_text[HD_YOUTH_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 14, 4, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_GENERAL_SAN_MARTINS_ANNIVERSARY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_PICNIC_DAY].ht_text),
            ptr_cc_id, "+", day, 8, year, hd_elems, fday, count);
   day = eval_holiday (DAY_MIN, 7, year, DAY_MIN, TRUE);
   holiday (*init_data, detected, _(hd_text[HD_ALICE_SPRINGS_SHOW_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 3, year, hd_elems, fday, count);
   day = eval_holiday (DAY_MIN, 7, year, DAY_MIN, TRUE) + DAY_MAX;
   holiday (*init_data, detected, _(hd_text[HD_TENNANT_CREEK_SHOW_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 3, year, hd_elems, fday, count);
   ...
   if (year > 1990)
    {
      ...
      holiday (*init_data, detected, _(hd_text[HD_SOLIDARITY_DAY].ht_text), ptr_cc_id,
               "+", dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
    }
}
...
*/
{
   ...
   */
   ...
   holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
   /*
...
*/
{
   ...
   if (*init_data)
     *init_data = FALSE;
   day = day_of_year (eval_holiday (DAY_MIN, 8, year, DAY_MIN, TRUE), 8, year) - 4;
   holiday (*init_data, detected, _(hd_text[HD_CUP_MATCH_DAY].ht_text),
            ptr_cc_id, "+", day, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SOMERS_DAY].ht_text),
            ptr_cc_id, "+", day+1, 0, year, hd_elems, fday, count);
   day = 26;
   i = weekday_of_date (day, MONTH_MAX, year);
   if (i > 5)
     day += 2;
...
*/
{
   ...
   if (*init_data)
     *init_data = FALSE;
   holiday (*init_data, detected, _(hd_text[HD_NEW_REGIME_ANNIVERSARY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_DAY].ht_text),
            ptr_cc_id, "+", 15, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_MOVEMENT_DAY].ht_text),
            ptr_cc_id, "+", dvec[7-1], 7, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            DIS_HLS_PREF, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_LIBERATION_DAY].ht_text), ptr_cc_id,
            (year > 1995) ? DIS_HLS_PREF : "+", 11, 9, year, hd_elems, fday, count);
}
...
*/
{
   ...
   if (i != DAY_MIN)
     day += ((DAY_MAX - i) + 1);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_OF_CARTAGENA].ht_text),
            ptr_cc_id, "+", day, 11, year, hd_elems, fday, count);
   day = 15;
   i = weekday_of_date (day, 8, year);
   if (i != DAY_MIN)
...
*/
{
   ...
   if (*init_data)
     *init_data = FALSE;
   holiday (*init_data, detected, _(hd_text[HD_OUR_LADY_OF_LOS_ANGELES_DAY].ht_text),
            ptr_cc_id, "#", 2, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, "#", 24, MONTH_MAX, year, hd_elems, fday, count);
...
{
   ptr_cc_id = "CY";
   holiday (*init_data, detected, _(hd_text[HD_ARCHBISHOP_MAKARIOS_NAME_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 19, MONTH_MIN, year, hd_elems, fday, count);
   if (*init_data)
     *init_data = FALSE;
   holiday (*init_data, detected, _(hd_text[HD_ARCHBISHOP_MAKARIOS_MEMORIAL_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 3, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_DAY].ht_text),
