/*
*  hd-data1.c:  All top 20 countries data which is composed into the
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_SAO_PAULO_ANNIVERSARY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 25, MONTH_MIN, year, hd_elems, fday, count);
   if (*init_data)
     *init_data = FALSE;
   holiday (*init_data, detected, _(hd_text[HD_RIO_DE_JANEIRO_ANNIVERSARY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 20, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_TIRADENTES_DAY].ht_text),
            ptr_cc_id, "+", 21, 4, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_OUR_LADY_APARECIDA_DAY].ht_text),
   ...
   for (i=5 ; i ; i--)
     holiday (*init_data, detected, _(hd_text[HD_CARNIVAL].ht_text),
              ptr_cc_id, DIS_HLS_PREF, easter-46-i, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_EASTER_SUNDAY].ht_text),
            ptr_cc_id, "+", easter, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_FEAST_OF_CORPUS_CHRISTI].ht_text),
            ptr_cc_id, "+", easter+60, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MARYS_ASCENSION_DAY].ht_text),
   ...
   holiday (*init_data, detected, _(hd_text[HD_MARYS_IMMACULATE_CONCEPTION].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 8, MONTH_MAX, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            DIS_HLS_PREF2, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
}
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_EASTER_MONDAY].ht_text),
            ptr_cc_id, "#", easter+1, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ALL_SAINTS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, DAY_MIN, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_FEAST_OF_CORPUS_CHRISTI].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter+60, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, DAY_MIN, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MARYS_ASCENSION_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 15, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MARYS_IMMACULATE_CONCEPTION].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 8, MONTH_MAX, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_THREE_KINGS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 6, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
            ptr_cc_id, "#", easter-2, 0, year, hd_elems, fday, count);
...
*/
{
   ...
   chinese_hdy (init_data, detected, year, hd_elems, fday, count, ptr_cc_id, FALSE);
   use_other_cc = !use_other_cc;
   if (year > 1911)
    {
      register int  day;
      ...
      if (year > 1920)
        holiday (*init_data, detected, _(hd_text[HD_FOUNDING_OF_THE_COMMUNIST_PARTY].ht_text),
...
*/
{
   ...
   if (year > 1516)
     holiday (*init_data, detected, _(hd_text[HD_REFORMATION_DAY].ht_text),
              ptr_cc_id, DIS_HLS_PREF2, dvec[10-1], 10, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_THREE_KINGS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 6, MONTH_MIN, year, hd_elems, fday, count);
   day = weekday_of_date (DAY_MIN, 11, year);
   day = (day < 3) ? 18-day : 25-day;
   holiday (*init_data, detected, _(hd_text[HD_DAY_OF_PRAYER_AND_REPENTANCE].ht_text), ptr_cc_id,
            (year > 1994) ? DIS_HLS_PREF2 : "+", day, 11, year, hd_elems, fday, count);
   if (year > 1953)
    {
      register int  month;
   ...
   holiday (*init_data, detected, _(hd_text[HD_WOMENS_SHROVE_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, easter-52, 0, year, hd_elems, fday, count);
   if (*init_data)
     *init_data = FALSE;
   day = eval_holiday (24, MONTH_MAX, year, DAY_MAX, FALSE);
   day -= (DAY_MAX * 4);
   holiday (*init_data, detected, _(hd_text[HD_SUNDAY_OF_THE_DEAD].ht_text),
            ptr_cc_id, DIS_HLS_PREF, dvec[11-1]+day, 11, year, hd_elems, fday, count);
   day -= DAY_MAX;
   ...
   holiday (*init_data, detected, _(hd_text[HD_ST_NICHOLAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 5, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SHROVE_TUESDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, easter-47, 0, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_VALBORGS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, dvec[4-1], 4, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            DIS_HLS_PREF2, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_BASQUE_NATIONAL_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter+1, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ALL_SAINTS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
   ...
   holiday (*init_data, detected, _(hd_text[HD_ST_STEPHENS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 26, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            DIS_HLS_PREF, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_THREE_KINGS_DAY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTS_ASCENSION_DAY].ht_text),
            ptr_cc_id, "+", easter+39, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-2, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MARYS_ASCENSION_DAY].ht_text),
            ptr_cc_id, "+", 15, 8, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_BURNS_NIGHT].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 25, MONTH_MIN, year, hd_elems, fday, count);
   if (*init_data)
     *init_data = FALSE;
   day = 12;
   ...
   holiday (*init_data, detected, _(hd_text[HD_BANK_HOLIDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, MONTH_MIN, year, hd_elems, fday, count);
   day = eval_holiday (DAY_MIN, 8, year, DAY_MIN, TRUE);
   holiday (*init_data, detected, _(hd_text[HD_BANK_HOLIDAY].ht_text),
   ...
   holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
            ptr_cc_id, "+", day, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            (year == 1999) ? "+" : DIS_HLS_PREF, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   /*
   ...
   */
   ...
   holiday (*init_data, detected, _(hd_text[HD_BEGINNING_OF_FINANCIAL_YEAR].ht_text),
            ptr_cc_id, DIS_HLS_PREF, day, 0, year, hd_elems, fday, count);
   if (year > 1604)
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_VENICE_CARNIVAL].ht_text),
            ptr_cc_id, DIS_HLS_PREF, easter-58, 0, year, hd_elems, fday, count);
   if (year > 1917)
    {
      day = 4;
...
*/
{
   ...
   if (year < 1873)
    {
      use_other_cc = !use_other_cc;
      japanese_hdy (init_data, detected, year, hd_elems, fday, count, ptr_cc_id, FALSE);
      use_other_cc = !use_other_cc;
    }
   else
    {
      ...
      */
      ...
      holiday (*init_data, detected, _(hd_text[HD_SAPPORO_SNOW_FESTIVAL].ht_text),
      ...
      for (i=0 ; i < 4 ; i++)
        holiday (*init_data, detected, _(hd_text[HD_FEAST_OF_FORTUNE].ht_text),
                 ptr_cc_id, DIS_HLS_PREF, day+i, 8, year, hd_elems, fday, count);
      day = 9;
      ...
      if (weekday_of_date (day, 9, year) == DAY_MAX)
        day++;
      holiday (*init_data, detected, _(hd_text[HD_RESPECT_FOR_THE_AGED_DAY].ht_text),
               ptr_cc_id, "+", day, 9, year, hd_elems, fday, count);
      day = 10;
      ...
      if (weekday_of_date (day, 11, year) == DAY_MAX)
        day++;
      holiday (*init_data, detected, _(hd_text[HD_LABOUR_THANKSGIVING_DAY].ht_text),
      ...
      if (i < 6)
        holiday (*init_data, detected, _(hd_text[HD_NATIONAL_HOLIDAY].ht_text),
                 ptr_cc_id, "+", day, 5, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_BANK_HOLIDAY].ht_text),
               ptr_cc_id, DIS_HLS_PREF2, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
               ptr_cc_id, "+", DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_ST_VALENTINES_DAY].ht_text),
               ptr_cc_id, DIS_HLS_PREF, 14, 2, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_BANK_HOLIDAY].ht_text),
               ptr_cc_id, DIS_HLS_PREF2, 2, MONTH_MIN, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_BANK_HOLIDAY].ht_text),
               ptr_cc_id, DIS_HLS_PREF2, 3, MONTH_MIN, year, hd_elems, fday, count);
      if (equinox_solstice (NH_VE, &day, &month, &y, hour, min) != (double)SPECIAL_VALUE)
       {
        ...
        y = year;
      if (equinox_solstice (NH_AE, &day, &month, &y, hour, min) != (double)SPECIAL_VALUE)
       {
         if (weekday_of_date (day, month, y) == DAY_MAX)
           (void)next_date (&day, &month, &y);
         holiday (*init_data, detected, _(hd_text[HD_EQUINOX_DAY].ht_text),
        ...
        y = year;
      if (equinox_solstice (NH_WS, &day, &month, &y, hour, min) != (double)SPECIAL_VALUE)
        holiday (*init_data, detected, _(hd_text[HD_JAPANESE_NEW_YEARS_DAY].ht_text),
                 ptr_cc_id, DIS_HLS_PREF, day, month, y, hd_elems, fday, count);
      else
        y = year;
      if (sun_longitude (315.0, &day, &month, &y, hour, min, FALSE) != (double)SPECIAL_VALUE)
       {
      ...
      if (year > 1946)
       {
         ...
         if (weekday_of_date (day, 2, year) == DAY_MAX)
           day++;
         holiday (*init_data, detected, _(hd_text[HD_NATIONAL_FOUNDATION_DAY].ht_text),
   ...
   if (year > 1911)
    {
      ...
      holiday (*init_data, detected, _(hd_text[HD_ALPHABET_DAY].ht_text), ptr_cc_id,
               (year > 1995) ? DIS_HLS_PREF : "+", 9, 10, year, hd_elems, fday, count);
      if (year > 1918)
        holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_MOVEMENT_DAY].ht_text),
      ...
      if (year > 1947)
       {
         ...
         holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
                  ptr_cc_id, DIS_HLS_PREF, 17, 7, year, hd_elems, fday, count);
         holiday (*init_data, detected, _(hd_text[HD_NATIONAL_FOUNDATION_DAY].ht_text),
...
*/
{
   ...
   for (day=DAY_MAX ; day ; day--)
     holiday (*init_data, detected, _(hd_text[HD_CARNIVAL].ht_text),
              ptr_cc_id, DIS_HLS_PREF, easter-46-day, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHILDRENS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, dvec[4-1], 4, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_FLAG_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, 2, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
            ptr_cc_id, "#", easter-2, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_HOLY_INNOCENTS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 28, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_DAY].ht_text),
            ptr_cc_id, "+", 16, 9, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_PROCLAMATION].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 15, 9, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MARYS_ASCENSION_DAY].ht_text),
   ...
   holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
   if (!(year % 6))
     holiday (*init_data, detected, _(hd_text[HD_PRESIDENTIAL_INAUGURATION].ht_text),
...
*/
{
   ...
   if (i > 4)
     ...
     day += (DAY_MIN - i);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_AUCKLAND].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 0, year, hd_elems, fday, count);
   if (*init_data)
     *init_data = FALSE;
   day = eval_holiday (DAY_MIN, 9, year, DAY_MIN, TRUE) + (3 * DAY_MAX);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_CANTERBURY_SOUTH].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 9, year, hd_elems, fday, count);
   ...
   if (i > 4)
     ...
     day += (DAY_MIN - i);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_CHATHAM_ISLANDS].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 0, year, hd_elems, fday, count);
   ...
   if (i > 4)
     ...
     day += (DAY_MIN - i);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_SOUTHLAND].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, MONTH_MIN, year, hd_elems, fday, count);
   day = eval_holiday (DAY_MIN, 3, year, DAY_MIN, TRUE) + DAY_MAX;
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_TARANAKI].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 3, year, hd_elems, fday, count);
   day = 22;
   i = weekday_of_date (day, MONTH_MIN, year);
   if (i > 4)
     ...
     day += (DAY_MIN - i);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_WELLINGTON].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, MONTH_MIN, year, hd_elems, fday, count);
   ...
   if (i > 4)
     ...
     day += (DAY_MIN - i);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_WESTLAND].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ANZAC_DAY].ht_text),
            ptr_cc_id, "+", 25, 4, year, hd_elems, fday, count);
   day = 26;
   ...
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", day, 10, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_HAWKES_BAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, day-3, 10, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_MARLBOROUGH].ht_text), ptr_cc_id,
            DIS_HLS_PREF2, day_of_year (day, 10, year)+DAY_MAX, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_CANTERBURY_NORTH].ht_text), ptr_cc_id,
            DIS_HLS_PREF2, day_of_year (day, 10, year)+(2*DAY_MAX)+4, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_NATIONAL_HOLIDAY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_ALL_SAINTS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ASH_MONDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-48, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_BOXING_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 26, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_MARYS_IMMACULATE_CONCEPTION].ht_text),
            ptr_cc_id, "+", 8, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MAUNDY_THURSDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-3, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_RE_DAY].ht_text),
            ptr_cc_id, "+", 5, 10, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SHROVE_TUESDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-47, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            DIS_HLS_PREF, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   if (year > 1944)
     holiday (*init_data, detected, _(hd_text[HD_LIBERATION_DAY].ht_text),
...
*/
{
   ...
   */
   ...
   if (i > 5)
     d += ((DAY_MAX - i) + 1);
   holiday (*init_data, detected, _(hd_text[HD_DEFENDERS_OF_MOTHERLAND_DAY].ht_text),
            ptr_cc_id, "+", d, 2, year, hd_elems, fday, count);
   d = DAY_MIN;
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-2, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_PRESIDENT_LINCOLNS_BIRTHDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 12, 2, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SHROVE_TUESDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, easter-47, 0, year, hd_elems, fday, count);
   if (year > 1844)
    {
   ...
   if (!use_other_cc)
    {
      ...
      if (*init_data)
        *init_data = FALSE;
      day = eval_holiday (DAY_MIN, MONTH_MIN, year, DAY_MIN, TRUE) + (2 * DAY_MAX);
      holiday (*init_data, detected, _(hd_text[HD_MARTIN_LUTHER_KINGS_DAY].ht_text),
               ptr_cc_id, "+", day, MONTH_MIN, year, hd_elems, fday, count);
      day = eval_holiday (DAY_MIN, 2, year, DAY_MIN, TRUE) + (2 * DAY_MAX);
      holiday (*init_data, detected, _(hd_text[HD_PRESIDENTS_DAY].ht_text),
               ptr_cc_id, "+", day, 2, year, hd_elems, fday, count);
   ...
   if (   (observe_us_hdy == SAFR_SUMO)
     ...
     holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text), ptr_cc_id,
