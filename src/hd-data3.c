/*
*  hd-data3.c:  All other D-L countries data which is composed into the
...
#if !HD_TOP20CC
#  ifdef RCSID
static char rcsid[]="$Id: hd-data3.c 3.01 2000/06/14 03:00:01 tom Exp $";
#  endif
...
*/
{
   ...
   day = weekday_of_date (DAY_MIN, 11, year);
   day = (day < 3) ? 18-day : 25-day;
   holiday (*init_data, detected, _(hd_text[HD_DAY_OF_PRAYER_AND_REPENTANCE].ht_text),
...
*/
{
   ...
   if (*init_data)
     *init_data = FALSE;
   holiday (*init_data, detected, _(hd_text[HD_OUR_LADY_OF_ALTAGRACIA_DAY].ht_text),
            ptr_cc_id, "+", 21, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_OUR_LADY_OF_LAS_MERCEDES_DAY].ht_text),
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, "+", 6, 11, year, hd_elems, fday, count);
...
*/
{
   ...
   if (*init_data)
     *init_data = FALSE;
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_OF_CUENCA].ht_text),
            ptr_cc_id, "+", 3, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_OF_GUAYAQUIL].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 9, 10, year, hd_elems, fday, count);
   ...
   if (year > 283)
    {
      ...
      */
      ...
      holiday (*init_data, detected, _(hd_text[HD_PENTECOST].ht_text),
               ptr_cc_id, DIS_HLS_PREF2, easter+49, 0, year, hd_elems, fday, count);
    }
}
...
*/
{
   ...
   islamic_hdy (init_data, detected, year, hd_elems, fday, count, ptr_cc_id);
   use_other_cc = !use_other_cc;
   holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_ARMED_STRUGGLE].ht_text),
...
*/
{
   ...
   use_other_cc = !use_other_cc;
   if (year > 1990)
     holiday (*init_data, detected, _(hd_text[HD_DOWNFALL_OF_THE_DERGUE].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 11, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, "#", 8, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 24, MONTH_MAX, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTS_ASCENSION_DAY].ht_text),
            ptr_cc_id, "+", easter+39, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 5, 6, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_REPUBLIC_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 7, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_REVOLUTION_DAY].ht_text), ptr_cc_id,
            "+", dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   if (year > 1978)
...
*/
{
   ...
   */
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_FEAST_OF_OUR_THEOTOKOS].ht_text),
            ptr_cc_id, "+", 26, MONTH_MAX, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_SCHOOL_HOLIDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 30, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            DIS_HLS_PREF, dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_THREE_KINGS_DAY].ht_text),
            ptr_cc_id, "+", 6, MONTH_MIN, year, hd_elems, fday, count);
...
*/
{
   ...
   */
   ...
   holiday (*init_data, detected, _(hd_text[HD_OUR_LADY_OF_CAMARIN_DAY].ht_text),
            ptr_cc_id, "+", 2, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ALL_SOULS_DAY].ht_text),
            ptr_cc_id, "+", 2, 11, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTS_ASCENSION_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter+39, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_EASTER_SUNDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-2, 0, year, hd_elems, fday, count);
...
*/
{
   ...
   islamic_hdy (init_data, detected, year, hd_elems, fday, count, ptr_cc_id);
   use_other_cc = !use_other_cc;
   holiday (*init_data, detected, _(hd_text[HD_MAHATMA_GANDHIS_BIRTHDAY].ht_text),
            ptr_cc_id, "+", 2, 10, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, "+", 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_GOOD_FRIDAY].ht_text),
...
*/
{
   ...
   */
   ...
   holiday (*init_data, detected, _(hd_text[HD_ARBOR_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 15, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_ARMED_FORCES_DAY].ht_text),
            ptr_cc_id, "+", 10, 6, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, 25, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   ...
   holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_PALM_SUNDAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, easter-DAY_MAX, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_SYLVESTER].ht_text), ptr_cc_id,
            "+", dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
...
*/
{
   ...
   chinese_hdy (init_data, detected, year, hd_elems, fday, count, ptr_cc_id, FALSE);
   use_other_cc = !use_other_cc;
   holiday (*init_data, detected, _(hd_text[HD_PARIS_PEACE_AGREEMENT_DAY].ht_text),
            ptr_cc_id, "+", 23, 10, year, hd_elems, fday, count);
...
*/
{
   ...
   islamic_hdy (init_data, detected, year, hd_elems, fday, count, ptr_cc_id);
   use_other_cc = !use_other_cc;
   holiday (*init_data, detected, _(hd_text[HD_DEATH_OF_PRESIDENT_CHEIKH].ht_text),
            ptr_cc_id, "+", 18, 3, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_DEATH_OF_PRESIDENT_SOILIH].ht_text),
            ptr_cc_id, "+", 29, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_DEATH_OF_PRESIDENT_ABDALLAH].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
            ptr_cc_id, "+", day, 5, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_PRINCE_OF_WALES_BIRTHDAY].ht_text),
            ptr_cc_id, "+", 14, 11, year, hd_elems, fday, count);
   day = eval_holiday (DAY_MIN, 6, year, 6, TRUE) + DAY_MAX;
   holiday (*init_data, detected, _(hd_text[HD_THE_QUEENS_BIRTHDAY].ht_text),
            ptr_cc_id, "+", day, 6, year, hd_elems, fday, count);
...
*/
{
   ...
   if (year > 1911)
    {
      holiday (*init_data, detected, _(hd_text[HD_CHILDRENS_DAY].ht_text),
               ptr_cc_id, DIS_HLS_PREF, DAY_MIN, 6, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_LABOUR_DAY].ht_text),
               ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
      holiday (*init_data, detected, _(hd_text[HD_NEW_YEARS_DAY].ht_text),
               ptr_cc_id, "+", DAY_MIN, MONTH_MIN, year, hd_elems, fday, count);
      ...
      if (year > 1947)
       {
         holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
                  ptr_cc_id, "+", 27, MONTH_MAX, year, hd_elems, fday, count);
         holiday (*init_data, detected, _(hd_text[HD_ANNIVERSARY_OF_ARMED_STRUGGLE].ht_text),
                  ptr_cc_id, DIS_HLS_PREF, 25, 6, year, hd_elems, fday, count);
         holiday (*init_data, detected, _(hd_text[HD_KIM_JONG_ILS_BIRTHDAY].ht_text),
                  ptr_cc_id, "+", 16, 2, year, hd_elems, fday, count);
         holiday (*init_data, detected, _(hd_text[HD_KIM_IL_SUNGS_BIRTHDAY].ht_text),
                  ptr_cc_id, "+", 15, 4, year, hd_elems, fday, count);
         holiday (*init_data, detected, _(hd_text[HD_ARMED_FORCES_DAY].ht_text),
                  ptr_cc_id, "+", 25, 4, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_FOUNDING_OF_PEOPLES_PARTY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_ALL_SAINTS_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 11, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_EVACUATION_DAY].ht_text), ptr_cc_id,
            "+", dvec[MONTH_MAX-1], MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_DAY].ht_text),
...
*/
{
   ...
   for (day=2 ; day ; day--)
     holiday (*init_data, detected, _(hd_text[HD_CARNIVAL].ht_text),
              ptr_cc_id, "+", easter-46-day, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_FEAST_OF_CORPUS_CHRISTI].ht_text),
            ptr_cc_id, "+", easter+60, 0, year, hd_elems, fday, count);
...
{
   ptr_cc_id = "LR";
   holiday (*init_data, detected, _(hd_text[HD_NATIONAL_REDEMPTION_DAY].ht_text),
            ptr_cc_id, "+", 12, 4, year, hd_elems, fday, count);
   if (*init_data)
     *init_data = FALSE;
   ...
   holiday (*init_data, detected, _(hd_text[HD_EASTER_SUNDAY].ht_text),
            ptr_cc_id, "+", easter, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_FLAG_DAY].ht_text),
            ptr_cc_id, "+", 24, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_INDEPENDENCE_DAY].ht_text),
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_CHRISTMAS_EVE].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 24, MONTH_MAX, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_CONSTITUTION_ANNIVERSARY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 25, 10, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_DEFENDERS_DAY].ht_text),
            ptr_cc_id, DIS_HLS_PREF, 13, MONTH_MIN, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_EASTER_MONDAY].ht_text),
            ptr_cc_id, "+", easter+1, 0, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_EASTER_SUNDAY].ht_text),
            ptr_cc_id, "+", easter, 0, year, hd_elems, fday, count);
...
*/
{
   ...
   holiday (*init_data, detected, _(hd_text[HD_LUXEMBOURG_CITY_KERMIS].ht_text),
            ptr_cc_id, DIS_HLS_PREF2, DAY_MIN, 9, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MARYS_ASCENSION_DAY].ht_text),
            ptr_cc_id, "+", 15, 8, year, hd_elems, fday, count);
   holiday (*init_data, detected, _(hd_text[HD_MAY_DAY].ht_text),
            ptr_cc_id, "+", DAY_MIN, 5, year, hd_elems, fday, count);
