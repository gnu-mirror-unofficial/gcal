#
# gcalltx.sed -- (C) Claus-Peter R"uckemann, 1996
#
# version 1.1
#
...
# IBM/AIX, SUN/Solaris and MSDOS. It should accept all country codes gcal uses.
#
...
%%
1i\
%% gcal output converted with gcalltx & gcalltx.sed (C) CPR, 1996, v1.1
1i\
%%
1i\
